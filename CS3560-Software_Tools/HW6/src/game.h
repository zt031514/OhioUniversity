...
protected:
	...
	/*!	\fn virtual void display_message(const std::string& message)const
		\brief Writes a string message to the screen.
		\param message The string that gets displayed to the screen. 
	*/
